...
public class AxeRechercheMapper {
    public AxeRechercheDTO toDto(AxeRecherche axeRecherche) {
        return new AxeRechercheDTO(
                axeRecherche.getId(),
                axeRecherche.getTitle(),
                axeRecherche.getLab() != null ? axeRecherche.getLab().getAcronym() : null,
                axeRecherche.getEquipe() != null ? axeRecherche.getEquipe().getId() : null
        );
    }
}
